...
const EmailCapture = () => {
  ...
  if (isSuccess) {
    return (
      <section id="email-capture" className="py-20 bg-gradient-to-br from-primary/5 via-secondary/5 to-accent/5">
            ...
            <div className="space-y-4">
              ...
              <div className="flex items-start space-x-3">
                ...
                <label
                  ...
                  className="text-small text-muted-foreground leading-relaxed cursor-pointer"
                >
